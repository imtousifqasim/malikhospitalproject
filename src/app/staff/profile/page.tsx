...
export default function StaffProfilePage() {
  ...
  const handleSaveProfile = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccessNotice("Your staff profile details have been updated.");
    } catch (err: unknown) {
  ...
  const handleVerifyEnrollment = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Generate 10 emergency backup codes for staff recovery
      ...
      const msg = err instanceof Error ? err.message : "Verification code invalid. Please try again.";
      setErrorNotice(msg);
    } finally {
        ...
        <body>
          <div class="header">
            <div>
              ...
              <p class="subtitle">Staff Two-Factor Authentication (2FA) Recovery Slip</p>
            </div>
          ...
          <div class="user-box">
            <div>
              <div class="user-label">Staff Member</div>
              <div class="user-val">${fullName || "Staff Member"}</div>
            </div>
            <div>
              <div class="user-label">Staff Email</div>
              <div class="user-val">${email}</div>
            </div>
            <div>
              <div class="user-label">Hospital Role</div>
              <div class="user-val">Hospital Staff Desk</div>
            </div>
            <div>
          ...
          <div class="notice">
            <strong>SECURITY INSTRUCTIONS:</strong> Each backup recovery code below can only be used <u>once</u> to access your hospital staff account if you lose access to your authenticator app. Store this sheet in a secure, private location.
          </div>
  ...
  const handleDownloadBackupCodes = () => {
    ...
    const lines = [
      ...
      "",
      "ACCOUNT DETAILS:",
      `  Staff Name:   ${fullName || "Staff Member"}`,
      `  Email:        ${email}`,
      `  Role:         Hospital Staff Desk`,
      `  Issued Date:  ${generatedDate}`,
      "",
      "----------------------------------------------------------------------",
      "SECURITY INSTRUCTIONS:",
      "Each backup code below can only be used ONCE to recover your staff account",
    ...
    a.href = url;
    a.download = `malik-hospital-2fa-backup-codes-${(fullName || "staff").toLowerCase().replace(/\s+/g, "-")}.txt`;
  ...
  return (
    <DashboardLayout
      ...
      pageTitle="Staff Profile & Settings"
    >
          ...
          <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                Manage your name and phone contact displayed on hospital appointment logs.
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleSaveProfile} className="space-y-4 text-xs">
            ...
            <div>
              ...
              <span className="text-[11px] text-slate-400 mt-1 block">
                To change your login email address, please contact the Executive Administrator.
              </span>
            </div>
            ...
            <div className="flex justify-end pt-2">
              <button
                ...
                className="px-5 py-2.5 rounded-xl text-xs font-bold bg-teal-600 hover:bg-teal-700 text-white flex items-center gap-1.5 cursor-pointer shadow-sm transition-colors"
              >
          ...
          <div className="flex items-center justify-between border-b border-slate-100 pb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">
                  Protects your staff desk account with Google Authenticator or Authy.
                </p>
              </div>
            </div>
          ...
          {!mfaEnrolled && !enrollingMfa && (
            <div className="space-y-4">
              <p className="text-xs text-slate-600 leading-relaxed">
                Add an extra layer of security to your staff account. When enabled, signing into `/staff/login` will require both your password and a 6-digit verification code from your authenticator app.
              </p>
              <button
            ...
            <div className="space-y-5 animate-in fade-in-50">
              <div className="p-4 bg-teal-50/70 border border-teal-200/80 rounded-2xl space-y-3">
                ...
                <p className="text-xs text-teal-800 leading-relaxed">
                  Open Google Authenticator, Authy, or Microsoft Authenticator on your phone and scan the code below:
                </p>
                ...
                <div className="text-center">
                  <span className="text-[11px] text-slate-500 block mb-1">
                    Or enter secret manually into app:
                  </span>
                  ...
                  {copiedSecret && <span className="text-[11px] text-teal-600 block mt-1 font-semibold">Copied to clipboard!</span>}
                </div>
              </div>
              ...
              <form onSubmit={handleVerifyEnrollment} className="space-y-3">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    placeholder="123456"
                    className="w-44 px-3 py-2 text-center font-mono text-base tracking-widest rounded-xl border border-slate-200 focus:ring-2 focus:ring-teal-600"
                  />
                  <button
                    type="submit"
                    disabled={verifyingCode || verificationCode.length !== 6}
                    className="px-5 py-2 rounded-xl text-xs font-bold bg-teal-600 hover:bg-teal-700 text-white flex items-center gap-1.5 cursor-pointer"
                  >
        ...
        <div className="bg-white rounded-3xl border border-slate-200 p-6 sm:p-8 shadow-xs space-y-5">
          <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                Update your login password for the staff desk.
              </p>
            </div>
          </div>
      ...
      <ConfirmDeleteModal
        ...
        description="Are you sure you want to remove 2FA from your staff account? Your account will only be protected by password and will no longer require an authenticator code."
